...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final String FILENAME = "Captured.jpg";
    ...
    private final CameraDevice.StateCallback mStateCallback = new CameraDevice.StateCallback() {
        ...
        public void onError(@NonNull CameraDevice cameraDevice, int error) {
            ...
            mCameraDevice = null;
            //finish();
            showToast("mStateCallback Error!");
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(ow.wilson.bluetoothaudiovideorecord.R.layout.activity_main);
        init();
    }
    @Override
    ...
    public void onClick(View view) {
        switch ( view.getId() ) {
            case ow.wilson.bluetoothaudiovideorecord.R.id.btn_record:
                ...
                //}
            break;
            case ow.wilson.bluetoothaudiovideorecord.R.id.btn_video:
    ...
    private void init() {
        ...
        isRecording = false;
        recordButton = (Button) findViewById(ow.wilson.bluetoothaudiovideorecord.R.id.btn_record);
        mTextureView = (TextureView) findViewById(ow.wilson.bluetoothaudiovideorecord.R.id.tv_video);
        mTextureView.setSurfaceTextureListener(mSurfaceTextureListener);
        mFile = new File(this.getExternalFilesDir(null), FILENAME);

        // Request use of Bluetooth SCO headset for communications.
        mAudioManager =  (AudioManager) getSystemService(Context.AUDIO_SERVICE);
        recordButton.setOnClickListener(this);
        findViewById(ow.wilson.bluetoothaudiovideorecord.R.id.btn_video).setOnClickListener(this);
    ...
    private void startRecording() {
        ...
        Log.i(TAG, "isBluetoothA2dpOn(): " + mAudioManager.isBluetoothA2dpOn());

        //dispatchTakeVideoIntent();

        /*mMediaRecorder = new mMediaRecorder();
        mMediaRecorder.setAudioSource(mMediaRecorder.AudioSource.MIC);
        mMediaRecorder.setOutputFormat(mMediaRecorder.OutputFormat.THREE_GPP);
        mMediaRecorder.setOutputFile(fileName);
        mMediaRecorder.setAudioEncoder(mMediaRecorder.AudioEncoder.AMR_NB);
    ...
    private void stopRecording() {
        ...
        Log.i(TAG, "2 isBluetoothA2dpOn(): " + mAudioManager.isBluetoothA2dpOn());
    }
